...
export default function SwitchLanguage() {
  ...
  return (
    <MUI.Switch
      checked={lang === "it"}
      aria-label={`Switch language to ${shownLang === "it" ? "Italian" : "English"}`}
      ...
      sx={{
        ...
        "& .MuiSwitch-switchBase": {
          ...
          "&.Mui-checked": {
            transform:
              "translateX(calc(calc(var(--switchDimension) * 3) - var(--switchDimension)))",
            "& + .MuiSwitch-track": {
        ...
        "& .MuiSwitch-track": {
          ...
          "&::before": {
            ...
            transform:
              "translateY(-50%) translateX(calc(var(--switchDimension)))",
