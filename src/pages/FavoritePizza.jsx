...
export default function FavoritePizza() {
    ...
    //   filter the pizzas helper   
        const favoritePizza = (data) =>
        data.filter((el) => likedPizzasId.includes(el.id)) || null;
    ...
    //   orgnized pizza data 
    const pizzaData = favoritePizza(pizzaRawData);
    ...
    return (
        <>
            ...
            <Typography variant="textTitle">Your favorite pizza list:</Typography>
            <Box component={"div"}>
            {/* Special Offer */}
            {(
