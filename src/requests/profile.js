...
export default function getProfileData(fetchedUserdata, t) {
  ...
  const text = {
    ...
    listItems: [
      [fetchedUserdata.personalInfo.firstName, Icons.Person_outlined, t("forms.fields.firstName.label"),  ""],
      [fetchedUserdata.personalInfo.lastName,  Icons.Person_outlined, t("forms.fields.lastName.label"),   ""],
      [fetchedUserdata.personalInfo.address,   Icons.Location,        t("pages.signup.form.sections.address.title"), "address"],
      [fetchedUserdata.personalInfo.zipcode,   Icons.Mailbox,         t("forms.fields.zipcode.label"),    "address"],
      [fetchedUserdata.personalInfo.email,     Icons.Email,           t("forms.fields.email.label"),      ""],
      [fetchedUserdata.personalInfo.phone,     Icons.Phone,           t("forms.fields.phone.label"),      ""],
      [
    ...
    inputs: {
      firstName: withUserPlaceholder("firstName", fetchedUserdata.personalInfo.firstName),
      lastName:  withUserPlaceholder("lastName",  fetchedUserdata.personalInfo.lastName),
      ...
      address:   withUserPlaceholder("address",   fetchedUserdata.personalInfo.address),
      zipcode:   withUserPlaceholder("zipcode",   fetchedUserdata.personalInfo.zipcode),
      addressExtra: withUserPlaceholder("addressExtra", fetchedUserdata.personalInfo.optional),
    },
  ...
  const pizzaRawData = Object.values(t("data:pizzas.items", { returnObjects: true }));
